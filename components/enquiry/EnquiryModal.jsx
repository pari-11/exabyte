...
export default function EnquiryModal({ isOpen, context, triggerEl, onClose }) {
  ...
  // only its own render output toggles to null — so dirtiness and the
  // opening pathname are tracked in refs (reset imperatively on open)
  // rather than state, since nothing here needs to trigger a re-render.
